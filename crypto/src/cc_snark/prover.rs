use crate::cc_snark::{CcGroth16, Proof, ProvingKey, VerifyingKey, r1cs_to_qap::R1CSToQAP};
use ark_ec::{AffineRepr, CurveGroup, Group, VariableBaseMSM, pairing::Pairing};
