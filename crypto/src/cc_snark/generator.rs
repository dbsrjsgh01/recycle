use crate::cc_snark::{CcGroth16, ProvingKey, Vec, VerifyingKey, r1cs_to_qap::R1CSToQAP};
use ark_ec::{CurveGroup, Group, pairing::Pairing, scalar_mul::fixed_base::FixedBase};
